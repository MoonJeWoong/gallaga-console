...
public class OutputView {
    ...
    private static final String ALERT_MESSAGE_FORMAT = """
            ...
            **********************************************************\n
            """;
    public static final String GAME_ENDED_MESSAGE = "적군이 목표 경계선을 돌파해 게임이 종료되었습니다.";
    private static final String VIEW_CLEAR_FORMAT = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";

    public static void printGameScreen(GameDto gameDto) {
        // 현재 게임 상태에 따른 화면을 출력한다.
        // 점수 라인 출력
        // 보드 출력
        System.out.println(VIEW_CLEAR_FORMAT);
